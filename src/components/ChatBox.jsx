...
const ChatBox = () => {
  return (
    <div className='h-[75vh] relative bg-white	'>
        <div className='px-2 py-4 flex items-center gap-3 border-b-2 '>
        ...
        <div className='h-[calc(100%-70px)] pb-12 overflow-y-scroll scrollbar-hide flex flex-col-reverse'>
            <div className='flex items-end justify-end gap-1 px-0 py-4 '>
            ...
            <div className='flex items-end justify-end gap-1 px-0 py-4 '>
                <img className='max-w-[230px] mb-8 rounded-lg' src={assets.pic1} alt="" />
                <div className='text-center text-[9px]'>
                    <img className='w-7 aspect-square rounded-[50%]' src={assets.profile_img} alt="" />
                    <p>2:30PM</p>
                </div>
